...
public class Bins {
    ...
    private static WorstFitAlgorithm algorithm = new WorstFitAlgorithm();
    ...
    public static void main (String args[]) {
        ...
        for (WorstFitAlgorithm al : algortihmsToCompare) {
            al.fitDisksAndPrint(data,e->Collections.reverse(e));
        }*/
        System.out.println(data);
        algorithm.fitDisksAndPrint(data, e->Collections.reverse(e));
        algorithm.fitDisksAndPrint(data, e->Collections.sort(e));
        algorithm.fitDisksAndPrint(data, e->Collections.shuffle(e));
    }
}
